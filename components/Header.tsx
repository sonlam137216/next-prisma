...
export default function Header() {
  const { cart, toggleCart } = useDashboardStore();
  const cartItemCount = cart.reduce((sum, item) => sum + item.quantity, 0);

  return (
    <>
      <div className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 border-b">
        <Sheet>
          ...
          <SheetContent side="left">
            ...
            <Link href="#" prefetch={false} className="flex items-center mb-6">
              <ShirtIcon className="h-6 w-6 mr-2" />
        ...
        <Link href="#" className="mr-6 flex items-center" prefetch={false}>
          <ShirtIcon className="h-6 w-6 mr-2" />
          <span className="font-bold text-lg hidden sm:inline">ShadCN</span>
        </Link>
